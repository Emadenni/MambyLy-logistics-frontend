export const microservicesData = {
  ...
  digital: [
    {
      id: "ds1",
      title: "Grundläggande digitala verktyg",
      description: "Få tillgång till realtidsspårning, automatisk fakturering och live-chatt för smidig kommunikation och ökad effektivitet.",
      type: "digital",
    },
    {
      id: "ds2",
      title: "Skräddarsydda logistiklösningar",
      description: "Anpassade digitala verktyg för att optimera och förbättra ditt logistikflöde enligt dina specifika behov.",
      type: "digital",
    },
    {
      id: "ds3",
      title: "Webbappar & specialbyggda system",
      description: "Vi utvecklar moderna, skalbara och skräddarsydda webbappar och system för att digitalisera din verksamhet.",
      type: "digital",
    },
  ]
};
